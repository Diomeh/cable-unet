            ...
            <div class="col-md-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form method="POST"
                            action="{{ __(isset($service) ? '/admin/services/update/internet/' . $service->id : '/admin/services/create/internet') }}">
                            @csrf
                            @isset($service)
                            ...
                            <div class="form-group row">
                                <label for="bandwidth"
                                    class="col-md-4 col-form-label text-md-right">{{ __('Bandwidth') }}</label>

                                <div class="col-md-6">
                                    <input id="bandwidth" type="number" step="1"
                                        class="form-control @error('bandwidth') is-invalid @enderror" name="bandwidth"
                                        value="{{ __(isset($service) ? $service->bandwidth : '') }}"
                                        autocomplete="bandwidth">
